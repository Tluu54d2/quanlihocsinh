...
// Route::get('/input-email',[BaseController::class,'getInputEmail'])->name('getInputEmail');
// Route::post('/input-email',[BaseController::class,'postInputEmail'])->name('postInputEmail');

Route::get('/input-email', 'BaseController@getInputEmail')->name('getInputEmail');
Route::post('/input-email', 'BaseController@postInputEmail')->name('postInputEmail');