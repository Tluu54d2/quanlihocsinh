                                ...
                                <div class="card card-stats radius shadow-2xl">
                                    ...
                                    <div class="card-body radius shadow-2xl">
                                        <div class="row">
                                            <div class="col">
                                                <a href="">
                                                    <h2 class="card-title text-uppercase text-muted mb-0">Số lượng học sinh</h2>
                                ...
                                <div class="card card-stats radius shadow-2xl">
                                    ...
                                    <div class="card-body radius shadow-2xl">
                                        <div class="row">
                                            <div class="col">
                                                <a href="">
                                                    <h2 class="card-title text-uppercase text-muted mb-0">Số lượng lớp học</h2>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="subject">chọn lớp học*</label>
