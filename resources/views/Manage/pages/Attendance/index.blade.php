                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush datatable-buttons">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="sort" data-sort="subject">Tên lớp học</th>
                                    <th scope="col" class="sort" data-sort="teacher">Giáo Viên</th>
                                    <th scope="col" class="sort" data-sort="students">số lượng học sinh</th>
                                    <th scope="col" class="sort" data-sort="date">ngày học</th>
                                ...
                                @foreach ($attendances as $attendance)
                                    <tr>
                                        ...
                                        <td class="text-capitalize">
                                            {{ $attendance->subject->description }}
                                        </td>
                                        <td class="text-capitalize">
