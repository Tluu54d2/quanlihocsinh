        ...
        <div class="modal-content">
            ...
            <form method="post" action="{{ route('attendance.store') }}">
                <div class="modal-body text-left">
                    @csrf
                    <h6 class="heading-small text-muted mb-4">Thêm lịch học</h6>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-control-label" for="subject">chọn lớp*</label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-control-label" for="input-date">Ngày học*</label>
