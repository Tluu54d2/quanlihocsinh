        ...
        <div class="modal-content">
            ...
            <form method="post" action="{{ route('subject.store') }}">
                <div class="modal-body text-left">
                        @csrf
                        <h6 class="heading-small text-muted mb-4">Thêm lớp học</h6>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="name">Tên lớp học*</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="description">Giáo Viên</label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary radius" data-dismiss="modal">Thoát</button>
                    <button type="submit" class="btn btn-primary radius">Thêm</button>
                </div>
            </form>
        </div>
    </div>
