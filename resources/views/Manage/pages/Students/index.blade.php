                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 text-white d-inline-block mb-0"> <a href="{{ route('dashboard') }}">Danh sách học sinh</a></h6>
                        ...
                        <div class="col-lg-6 col-5 text-right">
                            <button class="btn btn-sm btn-neutral"  data-toggle="modal" data-target="#createStudent"><i class="fas fa-plus mr-1"> </i> Thêm Mới học sinh </button>
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush datatable-buttons">
                                ...
                                <tr>
                                    <th scope="col" class="sort" data-sort="employee">Tên học sinh</th>
                                    <th scope="col" class="sort" data-sort="employee">Email</th>
                                    <th scope="col" class="sort" data-sort="service">sđt</th>
                                    <th scope="col" class="sort" data-sort="action">chức năng</th>
                                </tr>
                                </thead>
                                <tbody class="list">
